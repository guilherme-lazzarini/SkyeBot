...
//REGISTRO
const IMG_FAC = "https://i.imgur.com/AsvEl9H.png"
const COR_FAC = "13c2f3"
const ID_LOG = "781728698830815253"
const ROLE_ID = "721888302701084702"
...
var canal = message.guild.channels.cache.find(ch => ch.id === ID_LOG);
  ...
  //BD_CALCULA
    ...
    //MSG
    message.channel.send((`${message.author}`) + " **adicionou** a venda número `"+(registroatual)+"` de `"+(Qtd)+" "+(Item)+"` para `Midnight` no valor de `$" +(ValorTotal)+("`."))
