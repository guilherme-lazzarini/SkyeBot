...
//REGISTRO
const IMG_FAC = "https://i.imgur.com/6XB6VNB.png"
const COR_FAC = "e040c3"
const ID_LOG = "781728698830815253"
const ROLE_ID = "717088285050142843"
...
var canal = message.guild.channels.cache.find(ch => ch.id === ID_LOG);
  ...
  //BD_CALCULA
    ...
    //MSG
    message.channel.send((`${message.author}`) + " **adicionou** a venda número `"+(registroatual)+"` de `"+(Qtd)+" "+(Item)+"` para `Comando Rosa` no valor de `$" +(ValorTotal)+("`."))
